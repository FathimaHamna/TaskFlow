...
await _flutterLocalNotificationsPlugin
  ...
  try {
    ...
    await _firestore.collection('tasks').add({
      ...
      'reminders': remindersList, // Store as a list of reminder objects
    });
...
//     final int notificationId = '${taskId}_${scheduledTime.hour}:${scheduledTime.minute}'.hashCode;
    
//     await _flutterLocalNotificationsPlugin.zonedSchedule(
//       notificationId,
//       taskName,
//       taskDescription.isNotEmpty ? taskDescription : 'You have a scheduled task',
            ...
            if (timeParts.length == 2) {
              ...
              if (reminderHour == currentHour && 
                ...
                await _showTaskNotification(
                  notificationId,
                  data['name'] ?? 'Task Reminder',
                  data['description'] ?? 'It\'s time for your scheduled task',
                  doc.id
                );
              }
            }
        ...
        child: SafeArea(
          child: Column(
            ...
            children: [
              ...
              //     style: TextStyle(
              //       fontSize: 14,
              //       color: Colors.blue.shade200.withAlpha(179), // ~70% of the color
              //       letterSpacing: 0.2,
              //     ),
              //   ),
              // ),
